...
<head>
	...
	if (typeof(Storage) !== "undefined") {
		...
		var products_name = localStorage.getItem('products_name');
		var forOne = localStorage.getItem('forOne');
		var addon = localStorage.getItem('addon');
		var cart_data = localStorage.getItem('cart_data');
		console.log(cart_data+" asdf");
		
		// var xmlhttp = new XMLHttpRequest();   // new HttpRequest instance 
		// xmlhttp.open("POST", "/json-handler");
		// xmlhttp.setRequestHeader("Content-Type", "application/json");
		// xmlhttp.send(JSON.stringify({l_cart: cart, l_products_name : products_name, l_forOne: forOne, l_addon : addon}));
		var xhttp = new XMLHttpRequest();
	  	...
	  	xhttp.open("POST", "to_cart_local.php", true);
	  	xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	  	xhttp.send("cart_data="+cart_data);
	}
</script>
</head>
<body>
