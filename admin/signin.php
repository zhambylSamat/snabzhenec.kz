...
<section id='alert' style='position:absolute; top:3%; z-index: 100; width: 50%; left:25%;'>
	...
	<div class="alert alert-danger alert-dismissible" role="alert" style='margin:0; box-shadow: 0px 0px 50px black;'>
		<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  		<center>Превысили лимит входа! Аккаунт <strong>( <?php echo $_GET['name']; ?> ) заблокирован</strong>. Обратитесь тех. администратору.</center>
	</div>
	<?php 
		...
		<div class='container'>
			<div class='row'>
				<div class='col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1'>
					<form style='margin-top:30%;' action='admin-controller.php' method='post'>
						<h4>
