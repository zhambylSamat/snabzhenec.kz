...
<section id='order'>
	<div class='container'>
		...
		<h3>Примечание \ Комментарии</h3>
		<?php if($comment!='') {?>
		<p style='background-color: white; border:1px solid gray; border-radius: 3px; padding: 1% 3%;'>
